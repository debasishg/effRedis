...
class EffRedisSpec
  ...
  test("sortedsets zadd")(withRedis(sortedSetsZAddWithOptions))
  test("sortedsets zpopmin")(withRedis(sortedSetsZPopMin))
  test("sortedsets zpopmax")(withRedis(sortedSetsZPopMax))
  ...
  test("sortedsets zremrangebylex")(withRedis(sortedSetsZRemRangeByLex))
  ...
  test("sortedsets zlexcount")(withRedis(sortedSetsZLexCount))
  ...
  test("sorted sets api bzpopmin")(withRedis2(sortedSetsBZPopMin))
  test("sorted sets api bzpopmin")(withRedis2(sortedSetsBZPopMinWithTimeout))
  test("sorted sets api bzpopmin")(withRedis2(sortedSetsBZPopMax))
  test("sorted sets api bzpopmin")(withRedis2(sortedSetsBZPopMaxWithTimeout))
