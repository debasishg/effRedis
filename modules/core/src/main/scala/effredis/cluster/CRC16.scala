...
// adopted from https://introcs.cs.princeton.edu/java/61data/CRC16.java
/******************************************************************************
...
object CRC16 {
  ...
  def crc16(string: String)(implicit C: Charset = StandardCharsets.UTF_8): Int = {
    val base     = string.getBytes(C)
    var crc: Int = 0x0000
    base.foreach(b => crc = (crc >>> 8) ^ table(((crc ^ b) & 0xff)))
    crc
  }
}
