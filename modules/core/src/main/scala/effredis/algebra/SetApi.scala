...
trait SetApi[F[+_]] {
  ...
  /**
    ...
    */
  def sadd(key: Any, value: Any, values: Any*)(implicit format: Format): F[Resp[Long]]

  /**
    * Remove the specified members from the set value stored at key. (VARIADIC: >= 2.4)
    */
  def srem(key: Any, value: Any, values: Any*)(implicit format: Format): F[Resp[Long]]
  ...
  /**
    ...
    */
  def smove(sourceKey: Any, destKey: Any, value: Any)(implicit format: Format): F[Resp[Boolean]]

  /**
    * Return the number of elements (the cardinality) of the Set at key.
    */
  def scard(key: Any)(implicit format: Format): F[Resp[Long]]
  ...
  /**
    ...
    */
  def sinterstore(key: Any, keys: Any*)(implicit format: Format): F[Resp[Long]]
  ...
  /**
    ...
    * refer http://code.google.com/p/redis/issues/detail?id=121
    */
  def sunionstore(key: Any, keys: Any*)(implicit format: Format): F[Resp[Long]]
  ...
  /**
    ...
    * and store the resulting Set at dstkey.
    */
  def sdiffstore(key: Any, keys: Any*)(implicit format: Format): F[Resp[Long]]
