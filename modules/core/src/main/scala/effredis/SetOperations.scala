...
trait SetOperations[F[+_]] extends SetApi[F] { self: Redis[F] =>
  ...
  override def sadd(key: Any, value: Any, values: Any*)(implicit format: Format): F[RedisResponse[Option[Long]]] =
    send("SADD", List(key, value) ::: values.toList)(asLong)

  override def srem(key: Any, value: Any, values: Any*)(implicit format: Format): F[RedisResponse[Option[Long]]] =
    send("SREM", List(key, value) ::: values.toList)(asLong)

  override def spop[A](key: Any)(implicit format: Format, parse: Parse[A]): F[RedisResponse[Option[A]]] =
    send("SPOP", List(key))(asBulk)

  override def spop[A](
      key: Any,
      count: Int
  )(implicit format: Format, parse: Parse[A]): F[RedisResponse[Option[Set[Option[A]]]]] =
  ...
  override def scard(key: Any)(implicit format: Format): F[RedisResponse[Option[Long]]] =
    send("SCARD", List(key))(asLong)

  override def sismember(key: Any, value: Any)(implicit format: Format): F[RedisResponse[Boolean]] =
  ...
  override def sinterstore(key: Any, keys: Any*)(implicit format: Format): F[RedisResponse[Option[Long]]] =
  ...
  override def sunionstore(key: Any, keys: Any*)(implicit format: Format): F[RedisResponse[Option[Long]]] =
  ...
  override def sdiffstore(key: Any, keys: Any*)(implicit format: Format): F[RedisResponse[Option[Long]]] =
  ...
  override def srandmember[A](key: Any)(implicit format: Format, parse: Parse[A]): F[RedisResponse[Option[A]]] =
