...
import cats.effect.{ Concurrent, ContextShift, Blocker }
import algebra.BaseApi
import serialization._

class BaseOperations[F[_]: Concurrent: ContextShift] 
  (implicit blocker: Blocker) 
  extends BaseApi[F] with Redis {
  ...
  override def sort[A](key: String,
                       ...
                       get: List[String] = Nil)(implicit format: Format, parse: Parse[A]): F[Option[List[Option[A]]]] = {
  ...
  override def sortNStore[A](key: String,
                             ...
                             by: Option[String] = None,
                             get: List[String] = Nil,
                             storeAt: String)(implicit format: Format, parse: Parse[A]): F[Option[Long]] = {
  ...
  override def scan[A](cursor: Int, pattern: Any = "*", count: Int = 10)(implicit format: Format, parse: Parse[A]): F[Option[(Option[Int], Option[List[Option[A]]])]] =
